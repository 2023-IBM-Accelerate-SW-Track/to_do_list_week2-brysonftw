          ...
          <Card style={{marginTop:10}}>
            ...
            AddTodo.js. All we need to do is return the todo list item {todo.content} */}
              <ListItemButton component="a" href="#simple-list">
                <Checkbox
                  style={{paddingLeft:0,color:'primary'}} // Add style and color
                  onClick = {() => deleteTodo(todo.id)} // Add onClick event handler
                />
                <ListItemText 
                primary={todo.content}
                secondary={todo.date} // Add "date" property as second property
                />
              </ListItemButton>
          </Card>
        </Grid>
